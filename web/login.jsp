...
<div id="login">
    ...
    <div class="wrapper">
        ...
        <div class="login sign-in-htm">
            <form action="/SSM_LoginDemo/login" class="container offset1 loginform" method="get">
                <!-- 猫头鹰控件 -->
                    ...
                    <section class="content">
							<span class="input input--hideo">
								<input class="input__field input__field--hideo" type="text" id="login-username"
                                       autocomplete="off" placeholder="请输入用户名" tabindex="1" maxlength="15" name="uname" />
                        ...
                        <span class="input input--hideo">
								<input class="input__field input__field--hideo" type="password" id="login-password" placeholder="请输入密码" tabindex="2" maxlength="15" name="upwd"/>
...
<div style="text-align:center;">
    <p>版权所有：<a href="http://www.mycodes.net/" target="_blank">黄巍</a></p>
</div>
</body>
</html>
